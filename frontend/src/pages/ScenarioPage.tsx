...
import { Microscope, BarChart3, Lightbulb, AlertTriangle } from 'lucide-react'
        ...
        {shouldHideParameter('mci_score', industryMode) && (
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-medium text-amber-800">Mining Mode Active</h3>
                <p className="text-sm text-amber-700">Circularity scenarios (MCI, recycled content, lifespan) are not applicable for mining/extraction projects. This mode was auto-detected based on your input materials.</p>
              </div>
            </div>
          </div>
        )}

        {/* Show scenario controls only for manufacturing mode */}
        {!shouldHideParameter('mci_score', industryMode) && (
